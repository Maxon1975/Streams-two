...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //TODO Количество несовершеннолетних (возраст менее 18 лет)
        long underages = persons.stream().filter(person -> person.getAge() < 18).count();

        // TODO Список фамилий мужчин призывного возраста (возраст от 18  до 27 лет)
        ...
        //TODO Отсортированный по фамилии список работоспособных людей
        // с высшим образованием c дополнительными условиями (то есть людей с высшим образованием
